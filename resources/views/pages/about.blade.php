...
@section('content')
    <div class="container">
        ...
        <p>Feel free to helpto improve the <a href="https://github.com/ebycoco/{{config('app.name')}}-Ebychoco">souce code</a>.</p>
        <hr>
        <h2>what is Laramap?</h2>
        <p>Laramap is the website by which {{config('app.name')}} was inspire :).</p>
